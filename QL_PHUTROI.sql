...
select DINHMUCTIETDAY.SODINHMUCTIETDAY
from giaovien
inner join chitietchucvu on GIAOVIEN.MAGV = CHITIETCHUCVU.MAGV
inner join DINHMUCTIETDAY on DINHMUCTIETDAY.MACV = CHITIETCHUCVU.MACV
where giaovien.MAGV = '2001103392' AND CHITIETCHUCVU.NAMHOC = '2023-2024'