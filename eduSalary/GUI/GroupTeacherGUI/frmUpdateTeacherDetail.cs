...
{
    public partial class frmUpdateTeacherDetail : Form
    {
        ...
        public frmUpdateTeacherDetail(string _magv)
        {
            InitializeComponent();
            pMaGV = _magv;
            this.Load += FrmUpdateTeacherDetail_Load;
        ...
        private void FrmUpdateTeacherDetail_Load(object sender, EventArgs e)
        {
            loadDataChucDanh();
            loadDataChuyenMon();
            loadDataBacLuong();
