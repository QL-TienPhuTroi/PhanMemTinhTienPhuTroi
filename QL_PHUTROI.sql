...
--------------------- BẢNG CHỦ NHIỆM
INSERT INTO CHUNHIEM(MALP, MAGV, NAMHOC, TRANGTHAI)
VALUES
('LP10012550', '2001878553', '2023-2024', 1),
('LP10011843', '2001466041', '2023-2024', 1),
('LP10016752', '2001129533', '2023-2024', 1)



----------------------------------- TEST
SELECT * FROM CHUNHIEM ORDER BY MALP, MAGV, NAMHOC;
...
Select * from GIAOVIEN gv where gv.MAGV = '2001103392'
